...
public class ProcessingStateListBox extends AbstractFilterListBox {
    ...
    protected void configureItems() {
        ...
        this.addItem(i18n.format("option.with-errors"), "with_errors"); //$NON-NLS-1$ //$NON-NLS-2$
        this.addItem(i18n.format("option-successful"), "successful"); //$NON-NLS-1$ //$NON-NLS-2$
        this.addItem(i18n.format("option-running"), "running"); //$NON-NLS-1$ //$NON-NLS-2$
        this.addItem(i18n.format("option-waiting"), "waiting"); //$NON-NLS-1$ //$NON-NLS-2$
    }
