...
/**
 * Converts between a QName and a String, pulling out just the namespace.
 *
...
public class DataBindingQNameNamespaceConverter implements Converter<QName, String> {
     ...
     * Constructor.
     */
    public DataBindingQNameNamespaceConverter() {
    }
    ...
    public QName toModelValue(String widgetValue) {
        return new QName(widgetValue, ""); //$NON-NLS-1$
    }
    ...
    public String toWidgetValue(QName modelValue) {
        if (modelValue == null)
            ...
            return modelValue.getNamespaceURI();
    }
