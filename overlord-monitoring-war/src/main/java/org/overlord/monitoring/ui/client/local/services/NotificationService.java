...
import org.overlord.monitoring.ui.client.local.animations.FadeOutAnimation;
import org.overlord.monitoring.ui.client.local.animations.MoveAnimation;
import org.overlord.monitoring.ui.client.local.events.MouseInEvent;
import org.overlord.monitoring.ui.client.local.events.MouseOutEvent;
import org.overlord.monitoring.ui.client.local.services.notification.Notification;
import org.overlord.monitoring.ui.client.local.services.notification.NotificationConstants;
import org.overlord.monitoring.ui.client.local.services.notification.NotificationWidget;
...
public class NotificationService {
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, String message, UiException exception) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(String.valueOf(notificationCounter++));
     ...
     * @param exception
     */
    public final void sendErrorNotification(String title, UiException exception) {
    ...
    public final void sendErrorNotification(String title, Throwable exception) {
        if (exception instanceof UiException) {
            sendErrorNotification(title, (UiException) exception);
        } else {
     ...
     * @param exception
     */
    public final void completeProgressNotification(String uuid, String title, UiException error) {
        NotificationBean bean = new NotificationBean();
        bean.setUuid(uuid);
    ...
    public void completeProgressNotification(String uuid, String title, Throwable error) {
        if (error instanceof UiException) {
            completeProgressNotification(uuid, title, (UiException) error);
        } else {
    ...
    private void createNotificationWidget(final Notification notification) {
        ...
        widget.addMouseInHandler(new org.overlord.monitoring.ui.client.local.events.MouseInEvent.Handler() {
            @Override
        ...
        widget.addMouseOutHandler(new org.overlord.monitoring.ui.client.local.events.MouseOutEvent.Handler() {
            @Override
