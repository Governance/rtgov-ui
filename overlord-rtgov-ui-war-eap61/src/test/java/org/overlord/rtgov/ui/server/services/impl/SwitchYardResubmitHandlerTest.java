...
import org.overlord.rtgov.ui.server.services.impl.SwitchYardResubmitHandler;

public class SwitchYardResubmitHandlerTest {
	...
	public void testGetDefaultURL() {
		...
		if (!urls.get(0).equals(SwitchYardResubmitHandler.DEFAULT_REMOTE_INVOKER_URL)) {
