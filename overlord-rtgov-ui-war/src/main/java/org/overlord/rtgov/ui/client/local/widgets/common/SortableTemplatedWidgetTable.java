...
public abstract class SortableTemplatedWidgetTable extends TemplatedWidgetTable implements HasTableSortHandlers {
    ...
    /**
     * @see org.overlord.rtgov.ui.client.local.events.TableSortEvent.HasTableSortHandlers#addTableSortHandler(org.overlord.rtgov.ui.client.local.events.TableSortEvent.Handler)
     */
    @Override
