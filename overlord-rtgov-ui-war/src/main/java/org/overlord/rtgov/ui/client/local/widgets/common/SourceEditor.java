...
public class SourceEditor extends Widget implements HasValue<String> {
    ...
    public native void initACE(String id) /*-{
		...
		this.@org.overlord.rtgov.ui.client.local.widgets.common.SourceEditor::editor = editor;
    }-*/;
    ...
    public native String getValue() /*-{
        return this.@org.overlord.rtgov.ui.client.local.widgets.common.SourceEditor::editor.getValue();
    }-*/;
    ...
    public native void setEditorValue(String value) /*-{
		this.@org.overlord.rtgov.ui.client.local.widgets.common.SourceEditor::editor.setValue(value, -1);
    }-*/;
    ...
    protected native void destroyEditor() /*-{
		this.@org.overlord.rtgov.ui.client.local.widgets.common.SourceEditor::editor.destroy();
    }-*/;
